 ...
 *
 * Run: TSX_TSCONFIG_PATH=tsconfig.node.json npx tsx src/main/__tests__/computer-use-v3.test.ts
 */
...
const PLUGIN = path.join(REPO, 'src/defaults/workspace/brain/cerebellum/computer-use/plugin')
