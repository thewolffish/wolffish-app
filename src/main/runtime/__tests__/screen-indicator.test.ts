 ...
 *
 * Run: TSX_TSCONFIG_PATH=tsconfig.node.json npx tsx src/main/runtime/__tests__/screen-indicator.test.ts
 */
...
const agentSrc = read('src/main/runtime/agent/Agent.ts')
