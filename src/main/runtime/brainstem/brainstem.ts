...
import type { Cortex } from '@main/runtime/cortex/cortex'
import type { Hippocampus, KnowledgeFile } from '@main/runtime/hippocampus/hippocampus'
import type { ChatMessage, Thalamus } from '@main/runtime/thalamus/thalamus'
