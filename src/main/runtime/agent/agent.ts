...
import { Amygdala, SafetyBlockedError } from '@main/runtime/amygdala/amygdala'
import { BasalGanglia } from '@main/runtime/basalganglia/basalganglia'
import { Brainstem } from '@main/runtime/brainstem/brainstem'
import {
  Broca,
  type SegmentSink,
  type SegmentTurnEndReason,
  type ToolResultStatus
} from '@main/runtime/broca/broca'
import { Cerebellum } from '@main/runtime/cerebellum/cerebellum'
import { Corpus } from '@main/runtime/corpus/corpus'
import { Cortex } from '@main/runtime/cortex/cortex'
import { Device } from '@main/runtime/device/device'
import { Hippocampus, type TurnToolCall } from '@main/runtime/hippocampus/hippocampus'
import { Hypothalamus } from '@main/runtime/hypothalamus/hypothalamus'
import { Insula } from '@main/runtime/insula/insula'
import { Motor } from '@main/runtime/motor/motor'
import { Prefrontal, type ProviderContext } from '@main/runtime/prefrontal/prefrontal'
import { RAS } from '@main/runtime/ras/ras'
import {
  Thalamus,
  type ChatMessage,
  type FallbackMode,
...
import { Usage, calculateCost } from '@main/runtime/usage/usage'
import { Wernicke } from '@main/runtime/wernicke/wernicke'
import {
  processAttachments,
...
export type AgentTurnOptions = {
   ...
   */
  broca?: import('@main/runtime/broca/broca').Broca
  /**
